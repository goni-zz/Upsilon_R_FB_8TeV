...
void doFitUpsilon_Data_AllParmFree_pa_pt_0_1(
       int collId = kPADATA,  
       ...
       )
{
  ...
  if ( collId == kPADATA) 
  {
    ...
    //f1 = new TFile("../../skimmedFiles/PA_8TeV_Pbp_skimmed_Finalv2.root");
    //f2 = new TFile("../../skimmedFiles/PA_8TeV_pPb_skimmed_Finalv2.root");
