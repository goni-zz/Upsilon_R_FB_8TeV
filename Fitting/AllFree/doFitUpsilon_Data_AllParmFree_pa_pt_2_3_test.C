...
void doFitUpsilon_Data_AllParmFree_pa_pt_2_3_test(
       int collId = kPADATA,  
       float ptLow=2, float ptHigh=3,
       ...
       )
{
  ...
  if ( collId == kPADATA) 
  {
    f1 = new TFile("../../skimmedFiles/PA_8TeV_Pbp_skimmed.root");
    f2 = new TFile("../../skimmedFiles/PA_8TeV_pPb_skimmed.root");
  }
 
  float eta_low = -2.4;
  float eta_high = 2.4;
  TString kineLabel = getKineLabel (collId, ptLow, ptHigh, yLow-0.47, yHigh-0.47, muPtCut, cLow, cHigh, dphiEp2Low, dphiEp2High) ;
  ...
  RooRealVar *x1s = new RooRealVar("x1s","sigma ratio ", 0.5, 0, 2.5);
  ...
  RooRealVar alpha1s_1("alpha1s_1","tail shift", 2.0 , 1.2, 3.7);
  ...
  RooRealVar n1s_1("n1s_1","power order", 2.05 , 2.05, 2.05);
...
//  } 
  ...
  RooGaussDoubleSidedExp* G1s = new RooGaussDoubleSidedExp("gdse1s","GDoubleExp", mean1s, *(ws->var("mass")), sigma1s_1, alpha1s_1, n1s_1);
  RooGaussDoubleSidedExp* G2s = new RooGaussDoubleSidedExp("gdse2s","GDoubleExp", mean1s, *(ws->var("mass")), sigma1s_1, alpha1s_1, n1s_1);
  RooGaussDoubleSidedExp* G3s = new RooGaussDoubleSidedExp("gdse3s","GDoubleExp", mean1s, *(ws->var("mass")), sigma1s_1, alpha1s_1, n1s_1);

  //RooAddPdf* G1s = new RooAddPdf("G1s","Signal 1S",*GDSE1s);
  //RooAddPdf* G2s = new RooAddPdf("G2s","Signal 2S",*GDSE2s);
  //RooAddPdf* G3s = new RooAddPdf("G3s","Signal 3S",*GDSE3s);

///////
///////  RooAbsReal *dependent1s_1 = new RooRealVar("de1s_1","dependent1s", 0.5, 0, 1);
///////  RooAbsReal *dependent2s_1 = new RooRealVar("de2s_1","dependent2s", 0.5, 0, 1);
///////  RooAbsReal *dependent3s_1 = new RooRealVar("de3s_1","dependent3s", 0.5, 0, 1);
///////  RooAbsReal *dependent1s_2 = new RooRealVar("de1s_2","dependent1s", 0.5, 0, 1);
///////  RooAbsReal *dependent2s_2 = new RooRealVar("de2s_2","dependent2s", 0.5, 0, 1);
///////  RooAbsReal *dependent3s_2 = new RooRealVar("de3s_2","dependent3s", 0.5, 0, 1);
///////
///////  RooAbsReal *exponent1s_1 = new RooRealVar("de1s_1","exponent1s", 0.5, 0, 1);
///////  RooAbsReal *exponent2s_1 = new RooRealVar("de2s_1","exponent2s", 0.5, 0, 1);
///////  RooAbsReal *exponent3s_1 = new RooRealVar("de3s_1","exponent3s", 0.5, 0, 1);
///////  RooAbsReal *exponent1s_2 = new RooRealVar("de1s_2","exponent1s", 0.5, 0, 1);
///////  RooAbsReal *exponent2s_2 = new RooRealVar("de2s_2","exponent2s", 0.5, 0, 1);
///////  RooAbsReal *exponent3s_2 = new RooRealVar("de3s_2","exponent3s", 0.5, 0, 1);
///////
///////  RooExponential* Exp1s_1 = new RooExponential("exp1s_1","exponential");
///////  RooExponential* Exp2s_1 = new RooExponential("exp2s_1","exponential");
///////  RooExponential* Exp3s_1 = new RooExponential("exp3s_1","exponential");
///////  RooExponential* Exp1s_2 = new RooExponential("exp1s_2","exponential");
///////  RooExponential* Exp2s_2 = new RooExponential("exp2s_2","exponential");
///////  RooExponential* Exp3s_2 = new RooExponential("exp3s_2","exponential");
///////  
///////  RooAddPdf*  cb1s = new RooAddPdf("cb1s","Signal 1S",RooArgList(*Exp1s_1,*cb1s_1,*Exp1s_2), RooArgList(*f1s) );
///////  RooAddPdf*  cb2s = new RooAddPdf("cb2s","Signal 2S",RooArgList(*Exp2s_1,*cb2s_1,*Exp2s_2), RooArgList(*f1s) );
///////  RooAddPdf*  cb3s = new RooAddPdf("cb3s","Signal 3S",RooArgList(*Exp3s_1,*cb3s_1,*Exp3s_2), RooArgList(*f1s) );

///////  RooGaussian* cb1s_1 = new RooGaussian("cball1s", "cystal Ball", *(ws->var("mass")), mean1s, sigma1s_2);
///////  RooGaussian* cb2s_1 = new RooGaussian("cball2s", "cystal Ball", *(ws->var("mass")), mean2s, sigma2s_2);
///////  RooGaussian* cb3s_1 = new RooGaussian("cball3s", "cystal Ball", *(ws->var("mass")), mean3s, sigma3s_2);
  ...
  RooRealVar *nBkg = new RooRealVar("nBkg","fraction of component 1 in bkg",100000,0,5000000);  
  ...
  model = new RooAddPdf("model","1S+2S+3S + Bkg",RooArgList(*G1s, *G2s, *G3s, *bkg),RooArgList(*nSig1s,*nSig2s,*nSig3s,*nBkg));
  cout<<"TEST!!!!!!!!!!!!!!!"<<endl;
...
//if(yLow==0) drawText(Form("|y^{#mu#mu}| < %.1f",yHigh ), pos_text_x,pos_text_y-pos_y_diff,text_color,text_size);
  ...
  //TLegend* fitleg = new TLegend(0.68,0.4,0.83,0.7); fitleg->SetTextSize(19);
