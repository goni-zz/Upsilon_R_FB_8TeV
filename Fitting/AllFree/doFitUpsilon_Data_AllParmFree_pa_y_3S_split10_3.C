...
void doFitUpsilon_Data_AllParmFree_pa_y_3S_split10_3(
       int collId = kPADATA,  
       float ptLow=0, float ptHigh=30, 
       float yLow=-1.2, float yHigh=-0.8,
       ...
       )
{
  ...
  float n_min = 1.3, n_max = 9.9;
  float a_min = 1.2, a_max = 9.9;
  ...
  RooRealVar alpha1s_1("alpha1s_1","tail shift", 2.1 , a_min, a_max);
  ...
  RooRealVar n1s_1("n1s_1","power order", 2.1 , n_min, n_max);
...
//  } 
  ...
  RooRealVar err_mu("#mu","err_mu",5,  0, 30) ;
  RooRealVar err_sigma("#sigma","err_sigma", 5, 0,30);
