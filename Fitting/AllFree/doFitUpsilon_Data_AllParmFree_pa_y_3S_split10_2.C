...
void doFitUpsilon_Data_AllParmFree_pa_y_3S_split10_2(
       int collId = kPADATA,  
       float ptLow=0, float ptHigh=30, 
       float yLow=-1.6, float yHigh=-1.2,
       ...
       )
{
  ...
  RooRealVar alpha1s_1("alpha1s_1","tail shift", 2.1 , 1.2, 9.7);
  ...
  RooRealVar n1s_1("n1s_1","power order", 2.1 , 1.2, 9.3);
