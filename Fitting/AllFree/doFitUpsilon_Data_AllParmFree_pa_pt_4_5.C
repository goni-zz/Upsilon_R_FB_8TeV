...
void doFitUpsilon_Data_AllParmFree_pa_pt_4_5(
       int collId = kPADATA,  
...
//  } 
  ...
  RooRealVar err_mu("#mu","err_mu",5,  0, 50) ;
  RooRealVar err_sigma("#sigma","err_sigma", 5, 0,50);
  RooRealVar m_lambda("#lambda","m_lambda",  5, 0,50);
