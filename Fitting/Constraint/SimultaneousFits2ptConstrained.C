			...
			) 
{
  ...
  TString NomFileName = Form("../AllFree/AllParmFree_fitresults_upsilon_%s.root",kineLabel.Data());
  //AllParmFree_fitresults_upsilon_DoubleCB_5TeV_PA_DATA_pt6.0-8.0_y-1.93-1.93_muPt4.0.root
...
//Constraints
  ...
  myPlot2_A->GetXaxis()->SetTitleSize(0.058);
  myPlot2_A->GetXaxis()->SetLabelSize(0.054);
  myPlot2_A->Draw();
  ...
  myPlot2_B->GetXaxis()->SetTitle("m_{#mu^{+}#mu^{-}} (GeV/c^{2})");
  myPlot2_B->GetXaxis()->SetTitleSize(0.058);
  myPlot2_B->GetXaxis()->SetLabelSize(0.054);
  myPlot2_B->Draw();
  ...
  if (whichModel){
    ...
    c_A->SaveAs(Form("SimultaneousFits/sim_ptSplit3_nomfitresults_upsilon_DoubleCB_5TeV_%s.pdf",kineCut_A.Data()));
    c_A->SaveAs(Form("SimultaneousFits/sim_ptSplit3_nomfitresults_upsilon_DoubleCB_5TeV_%s.png",kineCut_A.Data()));
    c_A->Write();
    c_B->SaveAs(Form("SimultaneousFits/sim_ptSplit3_nomfitresults_upsilon_DoubleCB_5TeV_%s.pdf",kineCut_B.Data()));
    c_B->SaveAs(Form("SimultaneousFits/sim_ptSplit3_nomfitresults_upsilon_DoubleCB_5TeV_%s.png",kineCut_B.Data()));
    c_B->Write();
  }
