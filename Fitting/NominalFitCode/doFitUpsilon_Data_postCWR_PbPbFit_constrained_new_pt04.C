       ...
       int FixParm_seed=2  )
{
  ...
  if      ( collId == kPPDATA) f1 = new TFile("/home/deathold/work/CMS/analysis/Upsilon_RAA/upsilonRAA5TeV/skimmedFiles/yskimPP_L1DoubleMu0PD_Trig-L1DoubleMu0_OpSign_20164251755_3964bbec2f15f2cf9baa0676644690f40cee27c4.root");
    ...
    f1 = new TFile("/afs/cern.ch/work/g/goni/Analysis/Upsilon8TeV/src/Upsilon_R_FB_8TeV/skimmedFiles/PA_8TeV_Pbp_skimmed_L1DoubleMu0_SoftId.root");
    f2 = new TFile("/afs/cern.ch/work/g/goni/Analysis/Upsilon8TeV/src/Upsilon_R_FB_8TeV/skimmedFiles/PA_8TeV_pPb_skimmed_L1DoubleMu0_SoftId.root");
  }
  ...
  if ( (collId == kAADATA) || (collId == kAAMC) || (collId == kPAMC) || (collId == kAADATACentL3) || (collId==kAADATAPeri) )
  ...
  else if(collId==kPADATA || kPAMCUps1S || kPAMCUps2S || kPAMCUps3S) TString kineCut = Form("pt>%.2f && pt<%.2f && y>%.2f && y<%.2f && eta1<%.2f && eta1>%.2f && eta2<%.2f && eta2>%.2f",ptLow, ptHigh, yLow, yHigh, eta_high,eta_low, eta_high,eta_low );
