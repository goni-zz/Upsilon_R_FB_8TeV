...
void onia2ySkim_pPb( int nevt = -1,
		 int fileID = kPADATA,
		 ...
		 ) 
{
 ...
 //wFunc[1] = (TF1*) inf_func -> Get("dataMcRatio");
  ...
  if (fileID == kPADATA) {
    fname = "/eos/cms/store/group/phys_heavyions/dileptons/Data2016/PromptReco/pPb8TeV/TTrees/oniaTree_Pbp_20170504.root"; // in lxplus
    mytree->Add(fname.Data());
  }
  ...
  else if  (fileID == kPAMCUps1S){
    fname = "/home/samba/OniaTree/Onia5TeV/ppOfficialMC/OniaTree_Ups1SMM_5p02TeV_TuneCUETP8M1_HINppWinter16DR-75X_mcRun2_asymptotic_ppAt5TeV_v3-v1.root";
    mytree->Add(fname.Data());
  }
  else if  (fileID == kPAMCUps2S){
    fname = "/home/samba/OniaTree/Onia5TeV/ppOfficialMC/OniaTree_Ups1SMM_5p02TeV_TuneCUETP8M1_HINppWinter16DR-75X_mcRun2_asymptotic_ppAt5TeV_v3-v1.root";
    mytree->Add(fname.Data());
  }
  else if  (fileID == kPAMCUps3S){
    fname = "/home/samba/OniaTree/Onia5TeV/ppOfficialMC/OniaTree_Ups1SMM_5p02TeV_TuneCUETP8M1_HINppWinter16DR-75X_mcRun2_asymptotic_ppAt5TeV_v3-v1.root";
    mytree->Add(fname.Data());
  }
...
////////////////////////////////////////////////////////////////////////
  ...
  */  
  ...
  cout << "0. # of events in Tree : " << nevt << endl;
